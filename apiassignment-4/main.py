...
# =====================================================
# 🆕 DAY 5 — CART SYSTEM (USING id INSTEAD OF product_id)
# =====================================================
...
# ---------------- ADD TO CART ----------------
@app.post("/cart/add")
def add_to_cart(id: int, quantity: int = 1):
...
def checkout(data: CheckoutRequest):
    ...
    for item in cart:
        ...
        orders.append(order)  # uses your existing orders list
